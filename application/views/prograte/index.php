                ...
                <div class="container-fluid">
                    ...
                    <div class="col-lg-6">
					  ...
					  <div class="card-body">
					    ...
					    <a href="" class="card-link btn btn-primary" data-toggle="modal" data-target="#newPHPModal">Upload</a>
             ...
             <div class="row justify-content-end mt-4">
                <div class="col-sm-8">
                    <a href="<?= base_url('progate/tabelindex/'); ?>">Lihat tabel...</a>
                </div>
            </div>
  ...
  <!-- Modal -->
<div class="modal fade" id="newPHPModal"  tabindex="-1" aria-labelledby="newPHPModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="newPHPModalLabel">Prograte</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
        <?= form_open_multipart('progate'); ?>
